...
func TestFindGitSlug(t *testing.T) {
	...
	var slugTests = []struct {
		...
		{"https://github.com/ankit-arora/act.git", "GitHub", "nektos/act"},
		{"http://github.com/ankit-arora/act.git", "GitHub", "nektos/act"},
		{"https://github.com/ankit-arora/act", "GitHub", "nektos/act"},
		{"http://github.com/ankit-arora/act", "GitHub", "nektos/act"},
